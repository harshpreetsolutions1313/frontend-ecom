...
const Account = () => {
  ...
  const handleSignInSubmit = async (e) => {
    ...
    setMessage(null);
    try {
      const response = await fetch('https://ecom-ionajna1b-harshpreets-projects-89314032.vercel.app/api/auth/signin', {
        method: 'POST',
        headers: {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    setMessage(null);
    try {
      const response = await fetch('https://ecom-ionajna1b-harshpreets-projects-89314032.vercel.app/api/auth/signup', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
